# 🌟 Hola, soy **Pedro Paulo Zambrano Panduro**
...
- 📍 Tarapoto – Perú 🇵🇪  
- 🎓 Egresado de *Ingeniería de Sistemas* – Universidad Peruana Unión  
- 💻 Apasionado por el desarrollo web, apps móviles, bases de datos y gestión de TI  
- 🤖 Interés fuerte en Machine Learning, DevOps y Arquitectura de Software  
- 🚀 Proactivo, responsable y con mentalidad de mejora continua  
...
- Ingeniería de Sistemas – Universidad Peruana Unión  
- COBIT 2019, Pensamiento Sistémico, Gestión de Proyectos (OpenUP)  
- Desarrollo Web & Móvil  
- Bases de Datos & DevOps  
- Machine Learning (nivel inicial–intermedio)  
- Arquitectura Empresarial & Gobierno TI  
